...
<body class="bg-[#F8FAFC] text-slate-900 min-h-screen flex items-center justify-center py-5 px-4">
    <div class="w-full max-w-4xl bg-white rounded-[28px] shadow-[0_24px_48px_rgba(15,23,42,0.08)] overflow-hidden">
        <div class="grid grid-cols-1 lg:grid-cols-2 items-stretch">
            ...
            <!-- Right Side - Form -->
            <div class="p-5 lg:p-10 lg:border-l lg:border-slate-200">
                    ...
                    <div data-tab-panel="masuk" class="space-y-4">
                        <form action="{{ route('login.post') }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" class="w-full rounded-[16px] border border-slate-200 bg-slate-50 px-5 py-4 text-base outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Password</label>
                                <input type="password" name="password" class="w-full rounded-[16px] border border-slate-200 bg-slate-50 px-5 py-4 text-base outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100" required>
                            </div>
                            <button type="submit" class="w-full rounded-[16px] bg-indigo-600 text-white px-5 py-4 text-base font-semibold shadow-lg shadow-indigo-200/50 hover:bg-indigo-700 transition">Masuk</button>
                        </form>
